...
//
  ...
  private SerializedProperty tireScreechSound;
    ...
    // Lights
    private SerializedProperty backLightL;
    private SerializedProperty backLightR;
    ...
    tireScreechSound = SO.FindProperty("tireScreechSound");
        ...
        backLightL = SO.FindProperty("backLightL");
        backLightR = SO.FindProperty("backLightR");
    }
  ...
  public override void OnInspectorGUI(){
    ...
    EditorGUILayout.EndToggleGroup();
        ...
        EditorGUILayout.PropertyField(backLightR, new GUIContent("Left Break Light: "));
        EditorGUILayout.PropertyField(backLightL, new GUIContent("Right Break Light: "));
